...
\newcommand{\thesistitle}{Prediction of an Optical Amplifier Output Channel Power Excursion Using Machine Learning} % Your thesis title, this is used in the title and abstract
\newcommand{\degree}{MAI (Electronic and Computer Engineering)} % Your degree name, this is used in the title page and abstract
\newcommand{\typeofthesis}{dissertation} % dissertation, Final Year Project, report, etc.
\newcommand{\authorname}{Patrick Owens} % Your name, this is used in the title page and PDF stuff
...
\newcommand{\school}{\href{https://www.tcd.ie/eleceng/}{Department of Electronic and Electrical Engineering}} % Your school's name and URL, this is used in the title page
...
\usepackage[a4paper,top=2.5cm,bottom=2.5cm,left=2.5cm,right=2.5cm,headheight=16pt]{geometry}
...
% My Own packages
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\usepackage{tabularx} % for formatting the big table
\usepackage{placeins}
\usepackage{floatpag}   %suppressing the page numbering in figure/tables
\usepackage[justification=centering]{caption} %centering captions
\usepackage{caption}
\usepackage{subcaption}
\usepackage{pdflscape} % for sideways pages for figures
